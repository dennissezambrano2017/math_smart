"""
Django settings for smartgenius project.
...
if settings.DEBUG:
    # Estamos en un entorno local, no establecer X-Frame-Options
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tasks.context_processors.user_email',
            ],
        },
    },
]

WSGI_APPLICATION = 'smartgenius.wsgi.application'
